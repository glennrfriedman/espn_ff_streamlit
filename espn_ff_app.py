...
menu = ["Enter League Data", "Explore League Data"]
...
if choice == "Enter League Data" :
	if session_state.league_id!='' and session_state.swid !='' and session_state.espn_s2 !='' :
			...
			st.write('Your league data has been entered')
	else :
			...
			st.write('You need to ener your league data')
			if st.button('View League Data'):
				choice = "Explore League Data"
			else:
				choice = "Enter League Data"
else:
